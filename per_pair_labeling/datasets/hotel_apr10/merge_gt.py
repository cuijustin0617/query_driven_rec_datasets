...
# Path definitions
nyc_dir = "per_pair_labeling/datasets/hotel_apr10/nyc"
montreal_dir = "per_pair_labeling/datasets/hotel_apr10/montreal"
london_dir = "per_pair_labeling/datasets/hotel_apr10/london"
chicago_dir = "per_pair_labeling/datasets/hotel_apr10/chicago"

# Get CSV file paths
nyc_csv = os.path.join(nyc_dir, f"gemini_labels_apr10.csv")
montreal_csv = os.path.join(montreal_dir, f"gemini_labels_apr10.csv")
london_csv = os.path.join(london_dir, f"gemini_labels_apr10.csv")
chicago_csv = os.path.join(chicago_dir, f"gemini_labels_apr10.csv")

# Thresholds
MIN_THRESHOLD = 0.015  # 1.5%
MAX_THRESHOLD = 0.3    # 30%
