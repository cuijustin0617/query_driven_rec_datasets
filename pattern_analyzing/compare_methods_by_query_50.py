...
def main():
    ...
    output_name = f"{domain}_{method1}_vs_{method2}_top{top_n}"
    ...
    for i, query_id in enumerate(top_queries):
        print(f"{i+1}. {query_id}: {diff_by_query[query_id]:.3f}")
...
# Examples:
# Use all metrics:
python pattern_analyzing/compare_methods_by_query_50.py --domain travel --method1 eqr --method2 q2d --top_n 100

# Use only specific metrics:
python pattern_analyzing/compare_methods_by_query_50.py --domain restaurant --method1 eqr --method2 q2e --top_n 100 --metrics map_at10 recall_at10 rprecision
python pattern_analyzing/compare_methods_by_query_50.py --domain travel --method1 eqr --method2 q2d --top_n 90 --metrics map_at10 recall_at10 map_at30
python pattern_analyzing/compare_methods_by_query_50.py --domain hotel --method1 eqr --method2 q2e --top_n 100 --metrics map_at10 recall_at10 map_at30
