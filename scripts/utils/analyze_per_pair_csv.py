...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        csv_file_paths = [
            "per_pair_labeling/datasets/restaurant_apr15/new_orl/gemini_labels_apr15_part1.csv",
            "per_pair_labeling/datasets/restaurant_apr15/new_orl/gemini_labels_apr15_part2.csv",
            "per_pair_labeling/datasets/restaurant_apr15/new_orl/gemini_labels_apr15_part3.csv",
            "per_pair_labeling/datasets/restaurant_apr15/phi/gemini_labels_apr15_part1.csv",
            "per_pair_labeling/datasets/restaurant_apr15/phi/gemini_labels_apr15_part2.csv",
            "per_pair_labeling/datasets/restaurant_apr15/phi/gemini_labels_apr15_part3.csv",
