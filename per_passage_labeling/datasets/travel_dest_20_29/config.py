...
OUTPUT_DIR = BASE_DIR / "per_passage_labeling/datasets/travel_dest_20_29"
...
QUERY_START_INDEX = 20  # Start index (inclusive)
QUERY_END_INDEX = 29    # End index (inclusive) - set to process first 10 queries
